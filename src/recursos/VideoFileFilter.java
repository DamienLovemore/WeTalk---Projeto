...
/**
 * Utilizada para definir um filtro que aceita apenas arquivos que sejam um tipo de arquivo de vídeo.
 * @author Matheus Soares Martins
 *
 */
public class VideoFileFilter extends FileFilter //O import correto aqui é javax.swing.filechooser.FileFilter e não java.io.FileFilter;
{
	//Define os formatos de arquivos aceitos
	private final String[] okFileExtensions={"mp4","mkv","gif","webm","avi","flv","mov","wmv","3gb","3g2","mpg","vob","ogg","swf"};
	...
	public String getDescription() //Pelo fato dele estar extendendo, ele deve implementar esse método obrigatório que retorna a descrição.
	{
		...
		retorno = "Videos"; //O nome do filtro que aparecerá na hora de selecionar os arquivos.
